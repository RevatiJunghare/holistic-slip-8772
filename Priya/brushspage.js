...
localStorage.setItem("priya",JSON.stringify(priya));
let Rele=JSON.parse(localStorage.getItem("priya"));
...
let rel=document.getElementById('item1');
...
const starting=async()=>{
    ...
    const lakshmi=()=>{
        // console.log("priya");
     let sortdata= priya.sort(function(a,b){
...
let filter1=document.getElementById('type1');
...
let filter2=document.getElementById('type2');
...
let filter3=document.getElementById('type3');
...
let filter4=document.getElementById('type4');
